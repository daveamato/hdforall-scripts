...
//die();
      ...
      $h=shell_exec($exec);
$t1=explode('id="chserv"',$h);

$t1=explode('id="dodji">',$h);
$t2=explode('</Script>',$t1[1]);
$t3=explode("<Script Language='Javascript'>",$t2[1]);
...
//$h1=decode_code($h1);
//echo $h1;
preg_match_all('/([http|https][\.\d\w\-\.\/\\\:\?\&\#\%\_\,]*")/', $h1, $m);
//print_r ($m);
  $openload=str_replace('"',"",$m[0][$id_t-1]);
